...
<div class="top">
    ...
    <div class="info1">
        <div class="t1">分销佣金<span><?php  echo $commission;?></span>元</div>
...
<div class="info">
    ...
    <div class="con">
        ...
        <div class="line">
            ...
            <div class="t2">
                <div class="t3">从您转发的链接或图片进入商城的好友，<?php  if($this->set['become_child']==1) { ?>如果您的好友下单，<?php  } ?><?php  if($this->set['become_child']==2) { ?>如果您的好友下单并付款，<?php  } ?>系统将自动锁定成为您的客户, 他们在微信商城中购买任何商品，您都可以获得分销佣金；</div>
            </div>
        </div>
        <div class="line">
            <div class="t1">第三步</div>
            <div class="t2">
                <div class="t3">您可以在分销中心查看【我的团队】和【分销订单】，好友确认收货后佣金方可提现。</div>
            </div>
        </div>
    </div>
...
<!-- 底部浮层 开始 -->
<div class="bottom">
    <div id="btn1" class="sub" style="margin:0px;"><i class="fa fa-link" style="height:18px; width:18px; color:#fcac71; border:1px solid #fcac71; border-radius:20px; line-height:18px; text-align:center; font-size:14px;"></i> 链接分销</div>
    <div id="btn2" class="sub"><i class="fa fa-image" style="height:18px; width:18px; color:#63b3aa; border:1px solid #63b3aa; border-radius:20px; line-height:18px; text-align:center; font-size:12px;"></i> 图片分销</div>
</div>
