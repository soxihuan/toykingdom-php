			...
			<div class="panel-body">
				<div class="form-group" id="account">
					...
					<div class="col-sm-9 col-xs-12">
						...
						<span class="help-block">在微信公众号请求用户网页授权之前，开发者需要先到公众平台网站的【开发者中心】<b>网页服务</b>中配置授权回调域名。<?php  if($_W['isfounder']) { ?><a href="http://www.we7.cc/manual/dev:v0.6:qa:mobile_redirect_url_error" target="_black">查看详情</a><?php  } ?></span>
					</div>
				</div>
			</div>
			<div class="panel-body">
