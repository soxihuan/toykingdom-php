...
//$openid = 'oY828wql31Jw2d9UJ4xpv2XF5oCc';
...
// $ifstatus = $res['status'];
/*
 *在前端只对分销商展现佣金或者佣金比例，其他不展现
 */
    $res_display =1;
    $price = $goods['marketprice'];
   // $_price =array('1'=>number_format($price*$res['commission1']/100, 2),'2'=> number_format($price*$res['commission2']/100, 2),'3'=> number_format($price*$res['commission3']/100, 2));
...
// }
// $this->setHeader();
include $this->template('shop/detailCopy');
