			...
			<div class="panel-body">
				<div class="form-group" id="account">
					...
					<div class="col-sm-9 col-xs-12">
						...
						<span class="help-block">在系统中使用微信分享接口前，开发者需要先到公众平台网站的【公众号设置】 / 【功能设置】中配置 【JS 接口安全域名】。<?php  if($_W['isfounder']) { ?><a href="http://www.we7.cc/manual/dev:v0.6:qa:jsauth" target="_black">查看详情</a><?php  } ?></span>
					</div>
				</div>
			</div>
		</div>
