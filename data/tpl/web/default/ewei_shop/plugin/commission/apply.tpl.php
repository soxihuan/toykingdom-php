...
<div class="panel panel-info">
    ...
    <div class="panel-body">
	 ...
	 <div class="form-group">
		   ...
		   <?php if(cv('commission.agent.export'.$status)) { ?>   
        ...
        <table class="table table-hover">
            <thead class="navbar-inner">
                <tr>
                    ...
                    <th style='width:120px;'>分销等级</th>
                    <th style='width:100px;'>提现方式</th>
                    <th style='width:100px;'>申请佣金</th>
                     <?php  if($status>=1) { ?>
                    ...
                    <?php  } ?>
                    <?php  if($status>=3) { ?>
                    <th style='width:200px;'>打款时间</th>
                    <?php  } ?>
                       <?php  if($status==-1) { ?>
                    <th style='width:200px;'>设置无效时间</th>
                    <?php  } ?>
                    <th>操作</th>
                </tr>
            </thead>
...
<form <?php if(cv('commission.apply.check|commission.apply.pay|commission.apply.cancel')) { ?>action="" method='post'<?php  } ?> class='form-horizontal'>
                    ...
                    <thead class="navbar-inner">
                                       ...
                                       <tbody>
                                           ...
                                           <tr>
                                               ...
                                               <td>
                                                   <?php  if($this->set['level']>=1 && $row['level']==1) { ?><p>
