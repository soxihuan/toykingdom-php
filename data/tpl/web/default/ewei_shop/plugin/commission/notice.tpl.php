     ...
     默认为全部开启，用户在会员中心可自行设置是否开启, 模板消息自动替换变量
        ...
        <div class="col-sm-9 col-xs-12">
           ...
           <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">进店通知</label>
                <div class="col-sm-9 col-xs-12">
                    <input type="text" name="tm[commission_welcometitle]" class="form-control" value="<?php  echo $set['tm']['commission_welcometitle'];?>" />
                    <div class="help-block">标题，默认"进店通知"</div>
                </div>
            </div>
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label"></label>
                <div class="col-sm-9 col-xs-12">
                    <textarea  name="tm[commission_welcome]" class="form-control" ><?php  echo $set['tm']['commission_welcome'];?></textarea>
                    模板变量: [昵称]
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">发展新的分销通知</label>
                <div class="col-sm-9 col-xs-12">
                    <input type="text" name="tm[commission_agent_newpertitle]" class="form-control" value="<?php  echo $set['tm']['commission_agent_newpertitle'];?>" />
                    <div class="help-block">标题，默认"发展新的分销通知"</div>
                </div>
            </div>
             <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label"></label>
                <div class="col-sm-9 col-xs-12">
                    <textarea  name="tm[commission_agent_newper]" class="form-control" ><?php  echo $set['tm']['commission_agent_newper'];?></textarea>
                    <div class='help-block'>模板变量: [昵称] [时间]</div>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">导师分配提醒</label>
                <div class="col-sm-9 col-xs-12">
                    <input type="text" name="tm[commission_mentortitle]" class="form-control" value="<?php  echo $set['tm']['commission_mentortitle'];?>" />
                    <div class="help-block">标题，默认"导师分配提醒"</div>
                </div>
            </div>
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label"></label>
                <div class="col-sm-9 col-xs-12">
                    <textarea  name="tm[commission_mentor]" class="form-control" ><?php  echo $set['tm']['commission_mentor'];?></textarea>
                    <div class='help-block'>模板变量: [导师名字] [导师微信号]</div>
                </div>
            </div>
