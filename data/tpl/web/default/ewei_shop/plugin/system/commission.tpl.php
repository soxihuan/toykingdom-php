...
<div class="main">
    <form id="dataform" action="" method="post" class="form-horizontal form">
	 ...
	 <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">选择上级分销商</label>
                    <div class="col-sm-4">
                       <input type="hidden" id='agentid' name='agentid' class="form-control"  />
                        ...
                        <div class='input-group'>
                            ...
                            <div class='input-group-btn'>
                                <button class="btn btn-default" type="button" onclick="selectMember('agent')">选择上级分销商</button>
                ...
                <div class="col-sm-9 col-xs-12">
                    ...
                    <span class="help-block">固定上级后，任何条件也无法改变会员的上级，如果不选择上级分销商，且固定上级，则上级永远为总店（是分销商）或无上线（非分销商）</span>
