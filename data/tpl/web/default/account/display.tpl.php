					...
					<div class="panel-heading">
						<div class="row clearfix">
							<div class="col-xs-6" style="cursor:pointer; color:#999;">
								...
								<span class="setmeal-hover" style="margin-left:20px;" data-uid="<?php  echo $uni['setmeal']['uid'];?>"  data-name="<?php  echo $uni['name'];?>" data-groupid="<?php  echo $uni['setmeal']['groupid'];?>" data-uniacid="<?php  echo $uni['uniacid'];?>">
