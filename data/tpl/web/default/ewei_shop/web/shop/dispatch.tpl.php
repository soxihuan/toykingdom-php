            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:left;">
                         <?php if(cv('shop.dispatch.view|shop.dispatch.edit')) { ?><a href="<?php  echo $this->createWebUrl('shop/dispatch', array('op' => 'post', 'id' => $item['id']))?>" class="btn btn-default btn-sm" title="<?php if(cv('shop.dispatch.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>"><i class="fa fa-pencil"></i></a><?php  } ?>
