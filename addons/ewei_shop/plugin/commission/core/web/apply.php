...
if ($operation == "display") {
	...
	if ($_GPC["export"] == "1") {
		...
		m("excel")->export($exportlist, array("title" => $title . "佣金申请数据-" . date("Y-m-d-H-i", time()), "columns" => array(array("title" => "ID", "field" => "id", "width" => 12), array("title" => "提现单号", "field" => "applyno", "width" => 24), array("title" => "粉丝", "field" => "nickname", "width" => 12), array("title" => "姓名", "field" => "realname", "width" => 12), array("title" => "手机号码", "field" => "mobile", "width" => 12), array("title" => "订单号", "field" => "ordersn", "width" => 24), array("title" => "订单金额", "field" => "price", "width" => 12), array("title" => "订单级别", "field" => "level", "width" => 12), array("title" => "商品", "field" => "title", "width" => 24), array("title" => "数量", "field" => "total", "width" => 12), array("title" => "价格", "field" => "realprice", "width" => 12), array("title" => "状态", "field" => "cstatus", "width" => 12), array("title" => "商品佣金", "field" => "ccommission", "width" => 12), array("title" => "提现方式", "field" => "typestr", "width" => 12), array("title" => "申请时间", "field" => "applytime", "width" => 24), array("title" => "审核时间", "field" => "checktime", "width" => 24), array("title" => "打款时间", "field" => "paytime", "width" => 24), array("title" => "设置无效时间", "field" => "invalidtime", "width" => 24))));
	}
