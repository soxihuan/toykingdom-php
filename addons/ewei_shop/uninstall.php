...
drop table if exists " . tablename('ewei_shop_postera') . " ;
...
drop table if exists " . tablename('ewei_shop_diyform_category') . " ;
drop table if exists " . tablename('ewei_shop_diyform_data') . " ;
drop table if exists " . tablename('ewei_shop_diyform_temp') . " ;
drop table if exists " . tablename('ewei_shop_diyform_type') . " ;
drop table if exists " . tablename('ewei_shop_exhelper_express') . " ;
drop table if exists " . tablename('ewei_shop_exhelper_senduser') . " ;
drop table if exists " . tablename('ewei_shop_exhelper_sys') . " ;
drop table if exists " . tablename('ewei_shop_system_copyright') . " ;
";
pdo_query($sql);