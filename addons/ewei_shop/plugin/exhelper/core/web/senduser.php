...
if ($operation == "display") {
	...
	$list = pdo_fetchall("SELECT * FROM " . tablename("ewei_shop_exhelper_senduser") . " WHERE uniacid = '{$_W["uniacid"]}' ORDER BY isdefault desc , id DESC");
	...
	pdo_delete("ewei_shop_exhelper_senduser", array("id" => $id));
