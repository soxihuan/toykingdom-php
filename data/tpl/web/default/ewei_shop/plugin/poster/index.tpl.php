         ...
         <div class='panel-body'>
            ...
            <table class="table">
                ...
                <tbody>
				 ...
				 <?php  if($row['type']==4) { ?>
				<a class='btn btn-default' href="<?php  echo $this->createPluginWebUrl('poster/log', array('id' => $row['id']))?>"  title='关注记录'><i class='fa fa-qrcode'></i></a>
				<?php  } else { ?>
				<a class='btn btn-default' href="<?php  echo $this->createPluginWebUrl('poster/scan', array('id' => $row['id']))?>"  title='扫描记录'><i class='fa fa-qrcode'></i></a>
				<?php  } ?>
                            <?php  } ?>
