...
//     }
// }
// $_W['shopshare']['link'] = $this->createPluginMobileUrl('commission/inviteshares', array('inviter' => $member["id"]));
$_W["shopshare"] = array("title" => "我是窝在家店主，邀请你加入我们！", "imgUrl" => "http://static.52wzj.com/PT04ot111rZ4N1zB4ar0WC1044RTC1.jpg", "desc" => "吴昕喊你来窝在家0元开店创业啦！一件代发不囤货，赶快加入吧！！！", "link" => $this->createPluginMobileUrl("commission/invitesharesCopy", array("fakeOpenId" => $_GPC["fakeOpenId"],"isApp" => 'true')));
if ($_W["isajax"]) {
    $img = $this->model->createInviterImage($shop_set);
    die($img);
}

include $this->template("invitesharesCopy");